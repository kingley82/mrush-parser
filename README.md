...
В этой функции мы можем узнать сообщения из чата
```python
import mrush
mrush = mrush.Client("nickname", "password")
messages = mrush.chat(id="0", pages=1) #Где id это ID чата (0 для глобального или введите ID клана чтобы получить его сообщения), pages это кол-во страниц (1 страница = 15 сообщений)
```
В переменной messages будет словарь со словарями. В них будут данные о каждом сообщении:  
  
**nickname** - Имя игрока  
**text** - Текст сообщения
## Отправить сообщение в чат
В этой функции мы можем отправить сообщение в чат
```python
import mrush
mrush = mrush.Client("nickname", "password")
send = mrush.send_message(id="0", message="text") #Где id это ID чата (0 для глобального или введите ID клана чтобы получить его сообщения), message это текст сообщения
```
В случае успеха будет выведено ```Sended: 'text' to 0``` или ```<Response [...]>``` если возникла ошибка
